...
const Messages: FC<MessagesProps> = ({
  ...
  <div
    id='messages'
    className='flex h-full flex-1 flex-col-reverse gap-4 p-3 overflow-y-auto scrollbar-thumb-blue scroll-thumb-rounded scrollbar-track-blue-lighter scrollbar-w-2 scrolling-touch'>Messages
